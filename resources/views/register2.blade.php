...
<div class="flex justify-center">
    <div class="rounded-3xl shrink-0 w-full max-w-[1000px] mt-4 shadow-2xl bg-base-100" x-data="{ step: 1 }">
        ...
        @endif
        <form method="POST" action="{{ route('register2') }}" class="card-body" enctype="multipart/form-data">
            @csrf
            <h2 class="text-2xl font-bold text-center">Pré-Candidature</h2>
            <h3 class=" "> Remarque: Toutes les pièces doivent être en forme PDF.</h3>
            <div x-show="step === 1">
                <div>
                    <h1 class="text-2xl">3. Pièces Jointes</h1>
                </div>
                
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Les trois premières cases à gauche -->
                    <div class="sm:col-span-1">
                        <!-- Champ pour le Diplôme BAC PDF -->
                        <div>
                            <label class="label">
                                <span class="label-text">Diplôme BAC : </span>
                            </label>
                            <div class="form-control">
                                <input type="file" class="file-input file-input-bordered w-full" name="diplôme_BAC"/>
                            </div>
                        </div>
                
                        <!-- Champ pour le Diplôme BAC+3 ou +2 -->
                        <div>
                            <label class="label">
                                <span class="label-text">Diplôme BAC+2 ou +3 </span>
                            </label>
                            <div class="form-control">
                                <input type="file" class="file-input file-input-bordered w-full" name="diplôme_BAC2_3"/>
                            </div>
                        </div>
                
                        <!-- Champ pour le Relevé des Notes des Semestres -->
                        <div>
                            <label class="label">
                                <span class="label-text">Relevé des Notes des Semestres :</span>
                            </label>
                            <div class="form-control">
                                <input type="file" class="file-input file-input-bordered w-full" name="releve_note"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="form-control">
                            <input type="file" class="file-input file-input-bordered w-full" name="carteNT"/>
                        </div>
                    </div>
                </div>
                </div>
