        ...
        <div class="rounded-3xl shrink-0 w-full max-w-[1000px] mt-4 shadow-2xl bg-base-100" x-data="{ step: 1 }">
            ...
            <form method="POST" action="{{ route('register') }}" class="card-body" enctype="multipart/form-data">
                ...
                <div x-show="step === 1">
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Nom" name="nom" class="input input-bordered"
                                required />
                        </div>
                        <div class="form-control">
                            <label class="label">
                            ...
                            <input type="text" placeholder="الإسم العائلي" name="nom_arabe"
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Prenom" name="prenom" class="input input-bordered"
                                required />
                        </div>
                        <div class="form-control">
                            <label class="label">
                            ...
                            <input type="text" placeholder="الإسم الشخصي" name="prenom_arabe"
                                class="input input-bordered" required />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="CIN" name="cin" class="input input-bordered"
                                required />
                        </div>
                        <div class="form-control">
                            <label class="label">
                            ...
                            <input type="tel" placeholder="Telephone Portable" name="phone"
                                class="input input-bordered" pattern="[0-9]{10}" required />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="email" placeholder="Confirmation Email" name="confirmation_email"
                                class="input input-bordered" required />
                    ...
                    <div class="flex justify-end pt-3">
                        ...
                        <button type="button" class="btn btn-info " id="btn1" x-on:click="step = 2">
                            Suivant
                        </button>
                    </div>
                ...
                <div x-show="step === 2">
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <select class="select select-bordered w-full " name="serie_bac" required>
                                ...
                                <option value="BAC TECHNIQUES DE GESTION ET COMPTABILITÉ">BAC TECHNIQUES DE GESTION ET
                                    COMPTABILITÉ</option>
                                <option value="BAC TECHNIQUES DE GESTION ADMINISTRATIVE">BAC TECHNIQUES DE GESTION
                                    ADMINISTRATIVE</option>
                                <option value="BAC SCIENCES DE VIE ET DE TERRE">BAC SCIENCES DE VIE ET DE TERRE
                                </option>
                                ...
                                <option value="BAC SCIENCES ET TECHNOLOGIES ÉLECTRIQUES">BAC SCIENCES ET TECHNOLOGIES
                                    ÉLECTRIQUES</option>
                                <option value="BAC SCIENCES ET TECHNOLOGIES MÉCANIQUES">BAC SCIENCES ET TECHNOLOGIES
                                    MÉCANIQUES</option>
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Moyenne du Bac" name="moyenne_bac"
                                class="input input-bordered" required />
                        </div>
                        <div class="form-control">
                            <label class="label">
                            ...
                            <select class="select select-bordered w-full " name="annee_diplome" required>
                                <option disabled selected>-------------</option>
                                @for ($i = 1990; $i <= 2024; $i++)
                                    <option value="{{ $i }}">{{ $i }}</option>
                                @endfor
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <select class="select select-bordered w-full " name="montion_bac" required>
                                <option disabled selected>-------------</option>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Nom D'ettablissement" name="nom_etab"
                                class="input input-bordered" required />
                        </div>
                    ...
                    <div class="flex justify-between pt-3">
                        <button type="button" class="btn btn-info " x-on:click="step = 1">
                            Precedent
                        </button>
                        <button type="button" class="btn btn-info " id="btn2" x-on:click="step = 3">
                            Suivant
                        </button>
                    </div>
                ...
                <div x-show="step === 3">
                    ...
                    <div>
                        <h1 class="text-lg ">3. Pièces Jointes</h1>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            ...
                            <input type="file" placeholder="Lettre De Motivation" name="lettre_motivation"
                                class="file-input file-input-bordered w-full max-w-xs" required />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text">Derneier Diplome (*)</span>
                            </label>
                            <input type="file" placeholder="Derneier Diplome" name="file_derneier_diplome"
                                class="file-input file-input-bordered w-full max-w-xs" required />
                        </div>
                        <div class="form-control">
                            <label class="label">
                                <span class="label-text">Carte Nationale (*)</span>
                            </label>
                            <input type="file" placeholder="Carte Nationale" name="carteNT"
                                class="file-input file-input-bordered w-full max-w-xs" required />
                        </div>
                    </div>
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">Relevé des Notes des Semestres : (*)</span>
                        </label>
                        <input type="file" placeholder="Releve de Note" name="releve_note"
                            class="file-input file-input-bordered w-full max-w-xs" required />
                    </div>
                    <p><b>NB:</b>
                        <li>Toutes les pièces doivent être en forme PDF.</li>
                        <li> Le PDF doit être clair.</li>
                        <li>Les relevés de notes doivent être groupés dans un seul fichier PDF.</li></p>


                    <div class="flex justify-between pt-3">
                        <button type="button" class="btn btn-info " x-on:click="step = 2">
                            Precedent
                        </button>
            ...
            <div class="container px-6 mx-auto">
                <div class="flex justify-between">
                    <nav class="col-span-2 md:col-span-4 lg:col-span-3 w-[300px] " aria-labelledby="footer-header">
                        ...
                        <p>Cette page est dédiée au Centre de Formation Continue de la Faculté Hassan 2 des Sciences Aïn
                            Chock de Casablanca.</p>
                        <p>Elle offre des informations détaillées sur les programmes de formation continue disponibles,
                            ainsi que des détails sur les licences professionnelles et les masters spécialisés proposés
                    ...
                    <nav class="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-header">
                        ...
                        <ul>
                            <li>
                                <a href="https://web.facebook.com/FSAC2020/?_rdc=1&_rdr" target="_blank"
                                    class="text-blue-300 hover:text-blue-200 grisfsac">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48"
                                        height="16" width="16" class="w-4 h-4 shrink-0"
                                        role="graphics-symbol" aria-labelledby="title-tb01 desc-tb01">
                            ...
                            <li>
                                <a href="#" class="text-blue-300 hover:text-blue-200 grisfsac">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48"
                                        height="16" width="16" class="w-4 h-4 shrink-0"
                                        role="graphics-symbol" aria-labelledby="title-tb02 desc-tb02">
                            ...
                            <li>
                                <a href="#" class="text-blue-300 hover:text-blue-200 grisfsac">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48"
                                        height="16" width="16" class="w-4 h-4 shrink-0"
                                        role="graphics-symbol" aria-labelledby="title-tb03 desc-tb03">
                            ...
                            <li>
                                <a href="#" class="text-blue-300 hover:text-blue-200 grisfsac">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        height="16" width="16" class="w-4 h-4 shrink-0"
                                        role="graphics-symbol" aria-labelledby="title-instagram desc-instagram">
                                        <title id="title-instagram">Icon title</title>
                                        <desc id="desc-instagram">A more detailed description of the icon</desc>
                                        <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"
                                            d="M12 2.625a9.375 9.375 0 1 1 0 18.75 9.375 9.375 0 0 1 0-18.75zm0 1.875a7.5 7.5 0 1 0 0 15 7.5 7.5 0 0 0 0-15zm0 3.75a3.75 3.75 0 1 1 0 7.5 3.75 3.75 0 0 1 0-7.5zM17.25 5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm0 3.75a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5z" />
                                    </svg>
                                    Instagram
                                </a>
                            </li>
                    ...
                    <nav class="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-header">
                        ...
                        <div>
                            ...
                            <ul>
                                <li class="mb-4">
                                    <a href="#"
                                        class="flex items-center text-blue-300 hover:text-blue-200 grisfsac">
                                    ...
                                    <div class="flex items-start text-blue-300 hover:text-blue-200 grisfsac">
                                        ...
                                        <div>
                                            <a target="_blank"
                                                href="https://www.bing.com/search?pglt=43&q=Km+8+Route+d%27El+Jadida%2C+B.P+5366+Maarif+Casablanca+20100+Maroc&cvid=a5175137930146f4a7d9cae42c83e346&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDE4ODJqMGoxqAIIsAIB&FORM=ANNTA1&PC=U531">
                                                <span class="font-bold">ADRESSE</span>
                                                <span class="block">Km 8 Route d'El Jadida, B.P 5366 Maarif Casablanca
                                                    20100 Maroc</span>
                                            </a>
                                        </div>
                                    </div>
                ...
                <p class="text-center text-gray-450">© 2024 Centre de Formation Continue - Faculté Hassan 2 des
                    Sciences Aïn Chock de Casablanca. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
    <script>
