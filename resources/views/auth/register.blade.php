                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" >
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <img src="profile.jpg" id="img" alt="image" style=" max-width: 80px;max-height: 100px;margin-bottom:5px">
                                <br>
                                <div class="btn-group">
                                            ...
                                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                                                <div class="container mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"  id="datePicker" placeholder="Cliquez pour choisir une date">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="relative w-full mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group" style="">
                                                    <select name="statut" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" > id="id_statut">
